local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/XxzPoomzxX/UI/main/UI"))()
...
page1:Toggle("Toggle1",nil, function(value)
    print(value)
end)

page1:Button("Button1", function(value)
    print(value)
end)

page1:Button1("Button2", function(value)
    print(value)
end)
